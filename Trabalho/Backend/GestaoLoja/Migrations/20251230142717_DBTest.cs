        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MargemPercentual = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    PrecoFinal = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    Estado = table.Column<int>(type: "int", nullable: false),
                    ...
                    EmStock = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrinhoCompras_UserId_ProdutoId",
                table: "CarrinhoCompras",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favoritos_UserId_ProdutoId",
                table: "Favoritos",
                columns: new[] { "UserId", "ProdutoId" },
                unique: true);
