...
{
    /// <inheritdoc />
    public partial class MyCollDBMain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProdutoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FornecedorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Nome = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, null, "Coins", 1, null },
                    { 2, null, "Match boxes", 1, null },
                    { 3, null, "Stamps", 1, null },
                    { 4, null, "Playing Cards", 1, null },
                    { 5, null, "Brazil", 2, null },
                    { 6, null, "UK", 2, null },
                    { 7, null, "Japan", 2, null }
                });
