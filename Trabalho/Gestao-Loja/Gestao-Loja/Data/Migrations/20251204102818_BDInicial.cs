    ...
    public partial class BDInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModosDisponibilizacao", x => x.ModoDisponibilizacaoId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoCategorias", x => x.TipoCategoriaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentagemComissao = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ModoDisponibilizacaoId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categorias_TipoCategorias_TipoCategoriaId",
                        column: x => x.TipoCategoriaId,
                        principalTable: "TipoCategorias",
            ...
            migrationBuilder.InsertData(
                table: "ModosDisponibilizacao",
                columns: new[] { "ModoDisponibilizacaoId", "Ativo", "IsForSale", "Nome" },
                values: new object[,]
                {
                    { 1, true, true, "Para Venda" },
                    { 2, true, false, "Para Listagem" },
                    { 3, true, true, "Pré-Venda" },
                    { 4, true, false, "Esgotado" },
                    { 5, false, false, "Interno" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "CategoriaId", "Imagem", "Nome", "TipoCategoriaId", "UrlImagem" },
                values: new object[,]
                {
                    { 1, null, "Filme", 1, null },
                    { 2, null, "Música", 1, null },
                    { 3, null, "Jogo", 1, null },
                    { 4, null, "Série", 1, null },
                    { 5, null, "Sony", 2, null },
                    { 6, null, "Warner", 2, null },
                    { 7, null, "Universal", 2, null },
                    { 8, null, "EA Games", 2, null },
                    { 9, null, "Metallica", 3, null },
                    { 10, null, "Queen", 3, null },
                    { 11, null, "Eminem", 3, null },
                    { 12, null, "Coldplay", 3, null },
                    { 13, null, "Ação", 4, null },
                    { 14, null, "Drama", 4, null },
                    { 15, null, "Rock", 4, null },
                    { 16, null, "Pop", 4, null },
                    { 17, null, "RAP", 4, null },
                    { 18, null, "PS5", 5, null },
                    { 19, null, "Xbox", 5, null },
                    { 20, null, "PC", 5, null },
                    { 21, null, "Nintendo Switch", 5, null }
                });
